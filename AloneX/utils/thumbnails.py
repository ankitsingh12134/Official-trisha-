...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("AloneX/assets/thumb/font2.ttf", 32)
        regular_font = ImageFont.truetype("AloneX/assets/thumb/font.ttf", 18)
    except OSError:
...
# Progress bar
    ...
    # Icons
    icons_path = "AloneX/assets/thumb/play_icons.png"
